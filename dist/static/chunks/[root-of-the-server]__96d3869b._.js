...
"[project]/src/providers/QueryProvider.tsx [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function QueryProvider(param) {
    let { children } = param;
    _s();
    const [queryClient] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])({
        "QueryProvider.useState": ()=>new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$core$2f$build$2f$modern$2f$queryClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["QueryClient"]({
                defaultOptions: {
                    queries: {
                        staleTime: 5 * 60 * 1000,
                        gcTime: 10 * 60 * 1000,
                        ...
                        retry: {
                            "QueryProvider.useState": (failureCount, error)=>{
                                ...
                                if ((error === null || error === void 0 ? void 0 : (_error_response = error.response) === null || _error_response === void 0 ? void 0 : _error_response.status) >= 400 && (error === null || error === void 0 ? void 0 : (_error_response1 = error.response) === null || _error_response1 === void 0 ? void 0 : _error_response1.status) < 500) {
                                    return false;
                                }
...
_s(QueryProvider, "ikL8RCreIb3i8jeRPHpHX1IDP9g=");
_c = QueryProvider;
var _c;
...
"[project]/src/components/ErrorBoundary.tsx [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react/jsx-dev-runtime.js [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$providers$2f$QueryProvider$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/providers/QueryProvider.tsx [client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ErrorBoundary$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ErrorBoundary.tsx [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-hot-toast/dist/index.mjs [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react/index.js [client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
...
function MyApp(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MyApp.useEffect": ()=>{
            ...
            const handleError = {
                "MyApp.useEffect.handleError": (event)=>{
                    var _event_error;
                    console.error('Global error caught:', event.error);
                    if (((_event_error = event.error) === null || _event_error === void 0 ? void 0 : _event_error.name) === 'AxiosError') {
            ...
            const handleRejection = {
                "MyApp.useEffect.handleRejection": (event)=>{
                    var _event_reason;
                    console.error('Unhandled promise rejection:', event.reason);
                    // Always prevent AxiosError from showing in console as unhandled
                    if (((_event_reason = event.reason) === null || _event_reason === void 0 ? void 0 : _event_reason.name) === 'AxiosError') {
                        var _event_reason_config_url, _event_reason_config, _event_reason1;
                        ...
                        if ((_event_reason1 = event.reason) === null || _event_reason1 === void 0 ? void 0 : (_event_reason_config = _event_reason1.config) === null || _event_reason_config === void 0 ? void 0 : (_event_reason_config_url = _event_reason_config.url) === null || _event_reason_config_url === void 0 ? void 0 : _event_reason_config_url.includes('/auth/login')) {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error('A network error occurred. Please try again.');
                        return;
                    }
                    // For non-Axios errors, show generic error
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error('An unexpected error occurred. Please try again.');
                }
            }["MyApp.useEffect.handleRejection"];
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ErrorBoundary$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["ErrorBoundary"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$providers$2f$QueryProvider$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["QueryProvider"], {
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/src/pages/_app.tsx [client] (ecmascript)\" } [client] (ecmascript)": ((__turbopack_context__) => {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__96d3869b._.js.map