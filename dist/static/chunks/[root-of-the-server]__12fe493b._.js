...
"[project]/src/pages/admin/menu-items/[id]/edit.tsx [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function EditMenuItem() {
    ...
    const [initialLoading, setInitialLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditMenuItem.useEffect": ()=>{
            if (!id || typeof id !== 'string') return;
            const loadMenuItem = {
                "EditMenuItem.useEffect.loadMenuItem": async ()=>{
                    try {
                        var _response_data, _item_price;
                        setInitialLoading(true);
                        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["getMenuItem"])(id);
                        console.log('getMenuItem response:', response.data);
                        const item = ((_response_data = response.data) === null || _response_data === void 0 ? void 0 : _response_data.data) || response.data; // tùy theo cấu trúc API
                        setFormData({
                            name: item.name || '',
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error('Failed to load menu item');
                        router.push('/admin/menu-items');
                    } finally{
                        setInitialLoading(false);
                    }
                }
            }["EditMenuItem.useEffect.loadMenuItem"];
            loadMenuItem();
        }
    }["EditMenuItem.useEffect"], [
        id
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["updateMenuItem"])(id, submitData);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].success('Menu item updated successfully!');
            router.push('/admin/menu-items');
        } catch (error) {
    ...
    const handleDragOver = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "EditMenuItem.useCallback[handleDragOver]": (e)=>{
            e.preventDefault();
            setIsDragOver(true);
        }
    }["EditMenuItem.useCallback[handleDragOver]"], []);
    const handleDragLeave = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "EditMenuItem.useCallback[handleDragLeave]": (e)=>{
            e.preventDefault();
            setIsDragOver(false);
        }
    }["EditMenuItem.useCallback[handleDragLeave]"], []);
    const handleDrop = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "EditMenuItem.useCallback[handleDrop]": (e)=>{
            e.preventDefault();
            setIsDragOver(false);
            ...
            if (files.length > 0) {
                ...
                if (file.type.startsWith('image/')) {
                    ...
                    reader.onload = ({
                        "EditMenuItem.useCallback[handleDrop]": (event)=>{
                            var _event_target;
                    ...
                    })["EditMenuItem.useCallback[handleDrop]"];
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        fileName: "[project]/src/pages/admin/menu-items/[id]/edit.tsx",
                        lineNumber: 148,
                        columnNumber: 11
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-gray-600",
                        children: "Loading menu item..."
                    }, void 0, false, {
                        fileName: "[project]/src/pages/admin/menu-items/[id]/edit.tsx",
                        lineNumber: 149,
                        columnNumber: 11
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {}, void 0, false, {
                fileName: "[project]/src/pages/admin/menu-items/[id]/edit.tsx",
                lineNumber: 158,
                columnNumber: 9
            }, this),
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "Update the details of your menu item"
                                }, void 0, false, {
                                    fileName: "[project]/src/pages/admin/menu-items/[id]/edit.tsx",
                                    lineNumber: 172,
                                    columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            children: loading ? 'Updating...' : 'Update Menu Item'
                                        }, void 0, false, {
                                            fileName: "[project]/src/pages/admin/menu-items/[id]/edit.tsx",
                                            lineNumber: 342,
                                            columnNumber: 15
...
_s(EditMenuItem, "mfu4e3Wa3njZ6jnLMrxm7osL2X0=", false, function() {
    return [
...
_c = EditMenuItem;
var _c;
__turbopack_context__.k.register(_c, "EditMenuItem");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[next]/entry/page-loader.ts { PAGE => \"[project]/src/pages/admin/menu-items/[id]/edit.tsx [client] (ecmascript)\" } [client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const PAGE_PATH = "/admin/menu-items/[id]/edit";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/src/pages/admin/menu-items/[id]/edit.tsx [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/src/pages/admin/menu-items/[id]/edit.tsx\" }": ((__turbopack_context__) => {
"use strict";

var { m: module } = __turbopack_context__;
{
__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/src/pages/admin/menu-items/[id]/edit.tsx [client] (ecmascript)\" } [client] (ecmascript)");
}}),
}]);

//# sourceMappingURL=%5Broot-of-the-server%5D__12fe493b._.js.map