...
"[project]/src/pages/admin/users.tsx [ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AdminUsers() {
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        const loadUsers = async ()=>{
            try {
                setLoading(true);
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["fetchUsers"])();
                setUsers(data);
            } catch (error) {
                console.error('Error loading users:', error);
                __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error('Failed to load users');
            } finally{
                setLoading(false);
            }
        };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__587df93c._.js.map